...
Private Sub Workbook_Activate()
    ...
    If linha > restricao Then
        ...
        'Range(Cells(Linha, 1), Cells(Linha, 6)).Font.Bold = True 'caso queira em negrito tambem alem do destaque da cor 
    End If
End Sub
...
Private Sub Workbook_Deactivate()
    ...
    If linha > restricao Then
        ...
        'Range(Cells(Linha, 1), Cells(Linha, 6)).Font.Bold = False 'caso queira em negrito tambem alem do destaque da cor 
    End If
